...
#   * Finally, don't worry about the indent, CocoaPods strips it!  
  ...
  s.homepage         = "https://stash.mgmt.local/projects/IOSLIB/repos/test-pod-1/browse"
  s.license          = 'MIT'
  s.author           = { "Michael Leber" => "michael.leber@markit.com" }
  s.source           = { :git => "ssh://git@stash.mgmt.local/ioslib/test-pod-1.git", :tag => s.version.to_s }
