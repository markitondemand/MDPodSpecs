Pod::Spec.new do |s|
    ...
    s.description      = <<-DESC
        The AdhesionSDK is designed to serve different types of display ads, it is fully MRAID v2.0 compatibile and contains support for the following ad types
